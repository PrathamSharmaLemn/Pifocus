        ...
        <>
            ...
            <div className="sm:flex hidden flex-col items-center bg-customRadialBanner5 ">
                ...
                <div className="flex flex-row items-center bg-customRadialBanner5-2">
                    ...
                    <div className="ml-48">
                        <p className="text-3xl w-56 font-bold bg-gradient-to-r from-textGradientLeft to-textGradientRight inline-block text-transparent bg-clip-text">Tapasya Mode Fous, Redfined</p>
