    ...
    return (
        <>
            ...
            <div className="sm:flex hidden flex-col items-center py-12  bg-customRadialBanner6">
                ...
                <div className=" flex flex-row justify-center items-center sm:w-[500px] sm:h-[250px] md:w-[0px] mt-4 lg:h-[550px] lg:w-[1020px]  z-10  bg-bgImgaeBanner6 bg-no-repeat bg-contain bg-center">
