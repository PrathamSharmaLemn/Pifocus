        ...
        <>
            <div className="sm:hidden flex flex-col items-center px-4 bg-customRadialBanner6Mobile">
                ...
                <p className="text-xs text-center   text-white">
                    Discover a curated collection of apps designed to enhance your learning experience. The Pi Store offers a safe and secure platform to download and install apps, ensuring you have the tools you need to succeed.
                </p>
            </div>
